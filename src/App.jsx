...
import { Menu, X, Server, Bell, BarChart2, Shield, Clock, ChevronDown } from 'lucide-react';
...
const AIMSAlbanianLandingPage = () => {
  ...
  const features = [
    {
      ...
      description: "Përditësime të drejtpërdrejta dhe dukshmëri e plotë e stokut përmes teknologjisë së avancuar. Monitoroni dhe analizoni inventarin tuaj në kohë reale për të parandaluar mungesat, tepricat, dhe për të siguruar një menaxhim më të mirë të burimeve."
    },
    {
      icon: <Bell className="w-10 h-10 text-teal-400" />,
      title: "Njoftimet dhe Alarmet e Automatizuara",
      description: "Sistemi ju njofton menjëherë për stok të ulët, data skadimi, ose çdo anomali që kërkon vëmendjen tuaj. Automatizimi i njoftimeve ju ndihmon të qëndroni një hap përpara dhe të minimizoni rreziqet që mund të ndikojnë në operacionet tuaja."
    },
    {
      icon: <BarChart2 className="w-10 h-10 text-teal-400" />,
      title: "Analiza Parashikuese",
      description: "Parashikoni kërkesën për produkte dhe optimizoni nivelet e inventarit me analiza të fuqizuara nga të dhënat. Ky funksionalitet ndihmon në reduktimin e kostove, rritjen e efikasitetit dhe përmirësimin e përvojës së klientit."
    }
  ];
  ...
  const testimonials = [
    {
      quote: "InvenTek transformoi plotësisht menaxhimin tonë të inventarit. Saktësi dhe eficiencë absolute!",
      name: "Artan Hoxha",
      company: "Global Trade Solutions"
    },
    {
      quote: "Platforma më e avancuar për menaxhimin e inventarit që kam parë ndonjëherë.",
      name: "Ermira Gjinaj",
  ...
  <div className={`
      ...
      `}>
        <div className="container mx-auto flex justify-between items-center p-4">
          <div className="flex items-center space-x-3">
            <CloudIcon className="w-10 h-10 text-cyan-400" />
            <span className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">InvenTek</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            <h1 className="text-6xl font-bold mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">
              Revolucion në <br />Menaxhimin e Inventarit
            </h1>
            <p className="text-gray-300 text-xl mb-8">
              Zgjidhje IoT me bazë AI për gjurmimin dhe optimizimin inteligjent të inventarit.
            </p>
      ...
      <section ref={featuresRef} id="features" className="container mx-auto py-24 px-4">
        ...
        <div className={`
          ...
          ${animateFeatures ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}
        `}>
          {features.map((feature, index) => (
            <div 
              ...
              className={`
                ...
                ${activeFeature === index ? 'scale-105 shadow-2xl border-2 border-cyan-400' : ''}
                hover:shadow-2xl hover:scale-105
              `}
            >
              {feature.icon}
              <h3 className="text-2xl font-semibold mt-6 mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">{feature.title}</h3>
    ...
    <p className="text-lg text-center text-gray-300 mb-12">
      Zgjidhja jonë IoT inovative është krijuar për t'ju ndihmuar të optimizoni proceset dhe të monitoroni pajisjet tuaja 
      në mënyrë të zgjuar dhe të sigurt. Plotësoni formularin më poshtë për të rezervuar vendin tuaj dhe për të marrë më 
      shumë informacione mbi zgjidhjen tonë premium.
    </p>
  <div className="max-w-4xl mx-auto bg-gray-800/50 backdrop-blur-xl rounded-3xl p-12">
    ...
    <form onSubmit={handleContactSubmit} className="space-y-6">
      <div className="grid md:grid-cols-2 gap-6">
        {/* Name Field */}
        <div>
          <label htmlFor="name" className="block mb-2 text-sm text-gray-400">Emri</label>
          <div className="relative">
      ...
      {/* Company Field */}
      <div>
        <label htmlFor="company" className="block mb-2 text-sm text-gray-400">Kompania (Opsionale)</label>
        <div className="relative">
      ...
      {/* Message Field */}
      <div>
        <label htmlFor="message" className="block mb-2 text-sm text-gray-400">Mesazhi</label>
        <div className="relative">
          <textarea
            id="message"
